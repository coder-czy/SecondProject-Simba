  ...
  <div class="login">
    ...
    <div class="user-box">
      <div class="user-title">
        <div class="welcome">设置新密码!</div>
        <div class="sub-title">Set New password</div>
      </div>
      ...
      <van-form v-show="!isNext">
        ...
        >
           <template #button>
            <van-button size="small" color="#077655" :disabled="isSend" @click="getValidCode">{{text}}</van-button>
          </template>
        </van-field>
        <div class="forgot">
        ...
        <div class="commit-btn">
          <van-button @click="next" round block color="#077655">
            下一步
          </van-button>
        </div>
      </van-form>
      ...
      <van-form v-show="isNext">
        ...
        <div class="commit-btn">
          <van-button round block color="#077655" @click="commit">
            提交
          </van-button>
        </div>
        <div class="commit-btn">
